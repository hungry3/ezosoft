...
//                   <ReactQuill theme="snow" value={blog.content} onChange={handleContentChange} placeholder='Blog content' className='h-[280px]' />
...
//                       <ReactQuill theme="snow" value={detail.description} onChange={(value) => handleDetailDescriptionChange(value, detailIndex)} placeholder='Detail description' className='h-[280px] mb-3 ' />
//                     </div>
    ...
    <div className='h-[170px] w-[204px] border-2 border-[#293950] border-dashed rounded-lg bg-[#E7E8F1] flex items-center justify-center' onClick={handleImageClick}>
      ...
      <input type='file' accept='image/*' ref={fileInputRef} onChange={handleCoverImageChange} style={{ display: 'none' }} />
                ...
                <div className='flex flex-col mt-[20px] '>
                  <p className='text-[16px] leading-[21px] font-[Poppins] font-[400] mb-2'>Content</p>
                  <div className=''>
                  <ReactQuill value={blog.content} onChange={handleContentChange} className='w-full border-none' /> 
                  </div>
                  {errors.content && <span className='text-red-400'>Content is required</span>}
                </div>
