...
const AllTemplates = () => {
  ...
  const handleEdit = (row) => {
    ...
    navigate(`/editSingleUser/${row._id}`); 
  };
  ...
  const columns = [
    ...
    },
    {
      ...
      selector: (row) =>
          ...
          <div>
          <NavLink to={`/ViewSingleUser/${row._id}`} className='cursor-pointer hover:underline'>
    ...
    <>
      <div className='bg-[#F9F9F9]'>
        <div className='lg:mx-[70px] xl:mx-[70px] mx-[10px] mt-[53px] flex lg:flex-row xl:flex-row md:flex-row flex-col justify-between'>
          <p className='text-[25px] leading-[27px] font-semibold font-[Poppins]'>All Users</p>
