  ...
  return (
    <div className='bg-blue bg-[url("/src/assets/images/bgTrail.svg")] bg-no-repeat bg-cover '>
      ...
      <div className='relative z-10 flex flex-col items-center justify-center '>
       <p className=' text-white expo-medium text-center lg:text-[40px] xl:text-[40px] md:text-[35px] text-[30px] leading-[42px]'>Start your free 14 days trial</p>
       <p className='max-w-[693px] mt-[13px] text-white  text-center text-[16px] font-[Poppins] leading-[26px]'>Deliver faster, collaborate better and innovate more effectively without the high price tag or months-long implementation required by other products.</p>
