          ...
          {testimonials.map((testimonial, index) => (
            <div key={index} className='flex items-center justify-center w-full'>
              <div className='w-full '>
                <div className='flex flex-col justify-between w-full h-[291px] bg-[url("/src/assets/images/bg-slider.svg")] bg-cover bg-center rounded-md'>
                 <div className='w-full'>
                 <p className='pl-[20px] md:pl-[20px] lg:pl-[50px] xl:pl-[50px] py-[20px] md:py-[30px] lg:py-[50px] xl:py-[50px] max-w-[343px] font-[Poppins] text-[16px] leading-[26px]'>
                  ...
                  <div className='pl-[20px] md:pl-[30px] lg:pl-[30px] xl:pl-[40px] flex gap-2 mb-auto lg:mt-[30px] mt-[50px] mb-[10px]'>
                    <img
