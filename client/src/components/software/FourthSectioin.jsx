...
import Image from '/src/assets/images/fourthsection-img.svg'

import AOS from 'aos';
import 'aos/dist/aos.css';
function FourthSectioin() {
  AOS.init({
    duration: 1000, 
    delay: 300,     
  });
    ...
    <>
      <div>
       ...
       <div className='flex flex-col justify-center gap-4'  data-aos="zoom-in-right" data-aos-delay="400" >
        <p className='max-w-[542px] text-[30px] sm:text-[40px] leading-[50px] font-[500]'>We Can Help You Save Time And Money in Your Business</p>
